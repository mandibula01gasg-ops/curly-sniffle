...
export function Header({ cartItemsCount, onCartClick }: HeaderProps) {
  ...
  return (
    <>
      ...
      {/* Header principal */}
      <header className="w-full bg-gradient-to-br from-white to-purple-50 shadow-xl">
        <div className="container mx-auto px-4 py-6">
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="relative">
                <img 
                  ...
                  alt="Açaí Prime Logo" 
                  className="w-24 h-24 rounded-full shadow-2xl ring-4 ring-purple-200 object-cover"
                />
              </div>
              
              <div className="text-center">
                <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-purple-900 mb-1">
                  Açaí Prime
                </h1>
          ...
          {/* Informações do estabelecimento - centralizadas */}
          <div className="flex flex-col items-center gap-2 text-sm">
            {/* Linha 1: Pedido mínimo e Tempo de entrega */}
            <div className="flex items-center gap-4 text-gray-600">
              <div className="flex items-center gap-1.5">
                <DollarSign className="h-4 w-4 text-purple-600" />
                <span className="font-medium">Pedido Mínimo R$ 15,00</span>
              </div>
            ...
            <div className="flex items-center gap-1.5 text-gray-600">
              ...
              <span className="font-medium">{userLocation.city} - {userLocation.regionName}</span>
              <span className="text-gray-400">• 1.8km de você</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-gray-500 text-xs">(3.248 avaliações)</span>
              </div>
              
              <Badge className="bg-green-100 text-green-700 hover:bg-green-100 border border-green-300 font-bold px-3 py-1">
                ABERTO
              </Badge>
            </div>
          </div>
